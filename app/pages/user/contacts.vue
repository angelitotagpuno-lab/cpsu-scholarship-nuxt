<template>
	<div class="flex flex-col lg:flex-row bg-white dark:bg-gray-950 text-gray-900 dark:text-white p-8 gap-8 lg:gap-16">
		...
		<div class="flex-1 flex flex-col gap-6">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
				<div>
					<h3 class="text-sm font-semibold uppercase text-gray-500 dark:text-gray-400">General inquiries</h3>
				...
				<div>
					<h3 class="text-sm font-semibold uppercase text-gray-500 dark:text-gray-400">Collaborations</h3>
		...
		<div class="flex-1 flex justify-center">
			<UCard class="overflow-hidden rounded-xl shadow-md max-w-md">
				<img src="/contact.png" alt="Contact Illustration" class="w-full h-auto" />
			</UCard>
