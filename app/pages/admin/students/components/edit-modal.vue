...
async function onSubmit(event: FormSubmitEvent<Schema>) {
	const studentId = props.data.id || props.data.studentId || props.data.userId;
	...
	console.log("EDITING STUDENT:", props.data);
	console.log("USING ID:", studentId);
	console.log("PAYLOAD:", event.data);

	await store.editStudent(studentId, event.data);
